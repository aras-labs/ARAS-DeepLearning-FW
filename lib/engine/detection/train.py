...
def main(args):
    if args.output_dir:
        clean_log_folder.mkdir(args.output_dir)

    clean_log_folder.init_distributed_mode(args)
    print(args)
    ...
    data_loader = torch.utils.data.DataLoader(
        ...
        collate_fn=clean_log_folder.collate_fn)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            clean_log_folder.save_on_master(
                checkpoint,
